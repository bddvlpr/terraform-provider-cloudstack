		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"cloudstack_network.router_ips", "routeripv6", "2001:db8:10::2"),
				),
			},
		},
	})
...
resource "cloudstack_network" "router_ips" {
  ...
  startip          = "10.20.0.2"
  endip            = "10.20.0.250"
  ip6cidr          = "2001:db8:10::/64"
  ip6gateway       = "2001:db8:10::1"
  startipv6        = "2001:db8:10::2"
  endipv6          = "2001:db8:10::ffff"
  routerip         = "10.20.0.2"
  routeripv6       = "2001:db8:10::2"
